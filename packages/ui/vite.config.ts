...
// previewed against a real running @vayo-hq/server during development
...
// build's real consumer is @vayo-hq/server, which serves this bundle's
...
export default defineConfig({
  ...
  // after `pnpm build`, and @vayo-hq/server (the standalone-bundle consumer)
