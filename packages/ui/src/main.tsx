// Entry point for the STANDALONE bundle @vayo-hq/server serves at runtime
...
// `pnpm dev` against a real running @vayo-hq/server on localhost.
//
...
// build is meant to work unmodified wherever it's served) — so @vayo-hq/server
